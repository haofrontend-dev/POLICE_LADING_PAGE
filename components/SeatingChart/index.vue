...
onMounted(() => {
    const maketLeft = document.querySelector(".maket-left");
    const maketMiddle = document.querySelector(".maket-middle");
    const maketRight = document.querySelector(".matket-right");
});
</script>
